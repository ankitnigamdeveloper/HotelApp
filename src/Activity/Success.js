...
class Success extends React.Component  {
    ...
    return (
        <View style={{flex: 1, backgroundColor: '#f1f5f7'}}>
            ...
            <MaterialButton title='Go to All Booking'
                            style={{
                            ...
                            buttonPress={() => this.props.navigation.navigate("Menuside",{tag:6})}/>
                <MaterialButton title='OK'
                            ...
                            buttonPress={() => this.props.navigation.navigate("Menuside",{tag:3})}/>
