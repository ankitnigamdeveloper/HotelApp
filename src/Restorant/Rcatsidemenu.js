...
import {Dimensions, FlatList,StatusBar, Image, Text, TouchableOpacity, View} from "react-native";
...
function MainContent({navPress, snackbarRef,navigation, route}) {
    return (
        ...
        //  marginTop:StatusBar.currentHeight
            ...
            {/* <DummyPage/> */}
            <Restaurantscategory navigation={navigation} route={route}/>
