...
function HeaderThreeButton ({navPress, searchPress, morePress, bgColor='transparent',
 title='',
 isGallery=true, isHome=false, shadow=true, isenableMore=true}) {
    ...
    return (
        <View style={{
           ...
           {isGallery && (<TouchableOpacity onPress={searchPress} style={{padding: 10}}>
